...
const EditBox = ({ contentsToEdit }) => {
  ...
  return (
    <form onSubmit={async (e) => {
      ...
      setContent("");
    }} className="bg-white shadow-lg rounded-md flex gap-3 items-start p-5 w-full">
      <Image
        alt="dp"
      ...
      <div className="flex flex-col justify-end items-end w-full gap-3">
        ...
        <div className="flex gap-3">
          <button className="text-white bg-contents py-2 px-5 text-sm rounded-md">CANCEL</button>
